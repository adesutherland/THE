...
AREAS _THE_FAR valid_areas[ATTR_MAX]=
{
   ...
   {(CHARTYPE *)"POPUP"       ,5,WINDOW_FILEAREA   ,FALSE},
   {(CHARTYPE *)"POPUPDIVIDER",5,WINDOW_DIVIDER    ,FALSE},
   {(CHARTYPE *)"CBERROR"     ,7,WINDOW_FILEAREA   ,FALSE},
   {(CHARTYPE *)"CBWARN"      ,6,WINDOW_FILEAREA   ,FALSE},
   {(CHARTYPE *)"CBINFO"      ,6,WINDOW_FILEAREA   ,FALSE},
   {(CHARTYPE *)"PMSGERROR"   ,9,WINDOW_STATAREA   ,FALSE},
   {(CHARTYPE *)"PMSGWARN"    ,8,WINDOW_STATAREA   ,FALSE},
   {(CHARTYPE *)"PMSGINFO"    ,8,WINDOW_STATAREA   ,FALSE},
   };
...
//fprintf(stderr, "%s %d:get_key_definition; key %x keyname %s\n",__FILE__,__LINE__,key,keyname);
   /*
...
//fprintf(stderr, "%s %d:define; def_command %d def_params %s\n",__FILE__,__LINE__,curr->def_command, curr->def_params);
      curr = curr->next;
   }
   /*
...
//fprintf(stderr, "%s %d: def_command = -1 rc: %d\n",__FILE__,__LINE__,rc);
         }
         else
         {
            /*
...
//fprintf(stderr, "%s %d: !def_command = -1 rc: %d\n",__FILE__,__LINE__,rc);
         ...
         (*the_free)(key_cmd);
//fprintf(stderr, "%s %d: RC_OK %d RC_TOF_EOF_REACHED %d RC_NO_LINES_CHANGED %d RC_TARGET_NOT_FOUND %d\n",__FILE__,__LINE__,RC_OK,RC_TOF_EOF_REACHED,RC_NO_LINES_CHANGED,RC_TARGET_NOT_FOUND);
         if (rc != RC_OK
         &&  rc != RC_TOF_EOF_REACHED
         &&  rc != RC_NO_LINES_CHANGED
         &&  rc != RC_TARGET_NOT_FOUND)

...
#define UTF8_TERMINAL_DEFAULT_PROFILE_ENTRIES(ENTRY) \
   ...
   ENTRY(UTF8_TERM_CLASS_KEYCAP, "keycap", \
         ...
         UTF8_TERM_OUTPUT_NATIVE, "native", \
         UTF8_TERM_DEFAULT_SUBSTITUTE_CODEPOINT, 2, 2, \
         UTF8_TERM_STRATEGY_CLEAR_FROM_FIRST_CLUSTER_FAST, "flashfirstfast", \
         UTF8_TERM_STRATEGY_CLEAR_WHOLE_FAST, "flashwhole") \
   ...
   ENTRY(UTF8_TERM_CLASS_SHORT_ZWJ, "short-zwj", \
         UTF8_TERM_INTENT_GROUP, "group", \
         UTF8_TERM_OUTPUT_NATIVE, "native", \
         UTF8_TERM_DEFAULT_SUBSTITUTE_CODEPOINT, 2, 2, \
         UTF8_TERM_STRATEGY_LINE, "line", \
         UTF8_TERM_STRATEGY_LINE, "line") \
   ENTRY(UTF8_TERM_CLASS_SHORT_ZWJ, "short-zwj", \
         UTF8_TERM_INTENT_COMPONENTS, "components", \

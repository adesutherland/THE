...
Keycap clusters are previewed as the base character followed by a safe outline
marker; a standalone keycap combining mark `20E3` is shown as `K`. The code
values remain the original Unicode values.

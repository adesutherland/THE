...
The path parameter can be specified with or without the trailing directory separator. Under DOS,
OS/2 and Windows ports, the drive letter is considered part of the file's path.

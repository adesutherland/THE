...
'SET UTF TERMINAL CLASS short-zwj DISPLAY normal WIDTH 2 ADVANCE 2 CURSOR 2 REPAINT 2'
'SET UTF TERMINAL CLASS short-zwj DISPLAY decomposed CURSOR 5'
'SET UTF TERMINAL CLASS short-zwj DISPLAY decomposed CURSORSTRATEGY suffix'
'SET UTF TERMINAL CLASS short-zwj DISPLAY decomposed REPLACESTRATEGY prev'
...
grep -q "'SET UTF TERMINAL CLASS combining DISPLAY normal CURSORSTRATEGY suffix'" "${PROFILE}"
grep -q "'SET UTF TERMINAL CLASS combining DISPLAY normal REPLACESTRATEGY prev'" "${PROFILE}"
grep -q "'SET UTF TERMINAL CLASS keycap DISPLAY normal WIDTH 2 ADVANCE 2 CURSOR 2 REPAINT 2'" "${PROFILE}"
grep -q "'SET UTF TERMINAL CLASS keycap DISPLAY normal CURSORSTRATEGY whole'" "${PROFILE}"
grep -q "'SET UTF TERMINAL CLASS keycap DISPLAY normal REPLACESTRATEGY whole'" "${PROFILE}"
grep -q "'SET UTF TERMINAL CLASS short-zwj DISPLAY normal OUTPUT substitute U+0040'" "${PROFILE}"
grep -q "'SET UTF TERMINAL CLASS short-zwj DISPLAY normal WIDTH 2 ADVANCE 2 CURSOR 2 REPAINT 2'" "${PROFILE}"
grep -q "'SET UTF TERMINAL CLASS short-zwj DISPLAY decomposed WIDTH 5 ADVANCE 5 CURSOR 5 REPAINT 5'" "${PROFILE}"
grep -q "'SET UTF TERMINAL CLASS short-zwj DISPLAY decomposed CURSORSTRATEGY suffix'" "${PROFILE}"
grep -q "'SET UTF TERMINAL CLASS short-zwj DISPLAY decomposed REPLACESTRATEGY prev'" "${PROFILE}"
grep -q "'SET UTF TERMINAL CLASS family-zwj DISPLAY normal METRICS expanded'" "${PROFILE}"

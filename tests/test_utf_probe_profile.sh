...
'SET UTF TERMINAL CLASS short-zwj DISPLAY grouped LAYOUT 2 CURSOR 2'
...
grep -q "'SET UTF TERMINAL CLASS keycap LAYOUT 2 CURSOR 2 PAINT 2'" "${PROFILE}"
...
grep -q "'SET UTF TERMINAL CLASS short-zwj DISPLAY grouped LAYOUT 2 CURSOR 2 PAINT 2'" "${PROFILE}"

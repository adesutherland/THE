...
'SET UTF TERMINAL CLASS short-zwj DISPLAY grouped WIDTH 2 ADVANCE 2 CURSOR 2 REPAINT 2'
'SET UTF TERMINAL CLASS short-zwj DISPLAY components CURSOR 5'
...
grep -q "'SET UTF TERMINAL CLASS keycap WIDTH 2 ADVANCE 2 CURSOR 2 REPAINT 2'" "${PROFILE}"
...
grep -q "'SET UTF TERMINAL CLASS short-zwj DISPLAY grouped OUTPUT substitute U+0040'" "${PROFILE}"
grep -q "'SET UTF TERMINAL CLASS short-zwj DISPLAY grouped WIDTH 2 ADVANCE 2 CURSOR 2 REPAINT 2'" "${PROFILE}"
grep -q "'SET UTF TERMINAL CLASS short-zwj DISPLAY components WIDTH 4 ADVANCE 4 CURSOR 5 REPAINT 4'" "${PROFILE}"
